...
function gitstatus_prompt_update() {
  ...
  local      ready='%B%F{96}' # purple
  local      stash='%B%F{108}' # bright blue
...
PROMPT='%{$fg_bold[yellow]%} gkapfham %{$fg_bold[green]%} $(shrink_path -f) $(virtualenv_prompt_info)%{$reset_color%}$GITSTATUS_PROMPT%{$reset_color%}'
